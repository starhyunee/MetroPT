...
lm_d = {
        ...
        'MetroPT': [(0.99, 1), (0.999, 1)],
        'PSM': [(0.9995, 1.04), (0.9995, 1.06)],
        'NIPS_TS_Swan': [(0.9995, 1.04), (0.9995, 1.06)],
        'NIPS_TS_Water': [(0.9995, 1.04), (0.9995, 1.06)]
	}
lm = lm_d[args.dataset][1 if 'TranAD' or "Spatial" in args.model else 0]
